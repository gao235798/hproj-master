...
public class Const {
	 ...
	 * 字典类型
	 */
	public static final String DICT_TYPE_QTRZ_LOG_TYPE = "logQtrzType"; //Qtrz日志类型
	 ...
	 * 日志类型
	 */
	public static final String LOG_QTRZ_TYPE_1 = "1";//系统日志
	public static final String LOG_QTRZ_TYPE_2 = "2";//登陆日志
	public static final String LOG_QTRZ_TYPE_3 = "3";//导常日志
	...
	public static final String DATASOURCE_SLAVE01 = "slave01";
