...
import com.espread.common.shiro.ShiroUtil;
...
/**
 * 用户管理
 * @author itdragons 2016-8-21 13:42:46
 */
@Controller
...
public class SysUserController extends BaseController {
	...
	/**
	 * 用户管理页面  点击菜单 进入这个方法  返回sys/sysUser，通过spring 组成 sys/sysUser。jsp
	 * @return
	 */
	@RequestMapping(method = RequestMethod.GET)
    public String manager() {
		 //return "sys/search/searchUser";
        return "sys/sysUser";
    }
	...
	/**
	 * 用户列表
	 * @param page   // easyui datagrid 分页自带参数 page rows sort orde
	 * @param rows
	 * @param sort
	 * @param order
	 * @return
    ...
    */
    ...
    public Object edit(SysUserVo userVo, HttpSession httpSession ){
       ...
       // }catch (Exception e) {
		//	System.out.println("22数据转换异常{}");
			
		//	throw new ServiceException("66",e);
		//} finally {
			
		//	System.out.println("666数据转换异常{}");
