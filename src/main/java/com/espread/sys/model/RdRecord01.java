...
public class RdRecord01 implements Serializable {
    private Long id;
    ...
    public void setIarriveid(String iarriveid) {
        this.iarriveid = iarriveid == null ? null : iarriveid.trim();
    }
    ...
    public Integer getIcreditperiod() {
        return icreditperiod;
    }

    public void setIcreditperiod(Integer icreditperiod) {
    ...
    public Byte getBcredit() {
        return bcredit;
    }

    public void setBcredit(Byte bcredit) {
    ...
    public String toString() {
        ...
        sb.append(", ipurarriveid=").append(ipurarriveid);
        sb.append(", iarriveid=").append(iarriveid);
        ...
        sb.append(", icreditperiod=").append(icreditperiod);
