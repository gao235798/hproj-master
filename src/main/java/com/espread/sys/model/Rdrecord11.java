...
public class Rdrecord11 implements Serializable {
    private Long id;
    ...
    public void setCpspcode(String cpspcode) {
        this.cpspcode = cpspcode == null ? null : cpspcode.trim();
    }
    ...
    public Byte getBmotran() {
        return bmotran;
    }

    public void setBmotran(Byte bmotran) {
    ...
    public String toString() {
        ...
        sb.append(", cpspcode=").append(cpspcode);
        ...
        sb.append(", bmotran=").append(bmotran);
        ...
        sb.append(", bhyvouch=").append(bhyvouch);
