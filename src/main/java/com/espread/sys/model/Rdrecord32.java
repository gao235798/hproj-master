...
public class Rdrecord32 implements Serializable {
    private Long id;
    ...
    private Byte buploaded;

    private String outid;

    private Byte ismddispatch;
    ...
    public void setIsalebillid(String isalebillid) {
        this.isalebillid = isalebillid == null ? null : isalebillid.trim();
    }
    ...
    public Byte getBscanexpress() {
        return bscanexpress;
    }

    public void setBscanexpress(Byte bscanexpress) {
        this.bscanexpress = bscanexpress;
    }
    ...
    public Date getDinspecttime() {
        return dinspecttime;
    }

    public void setDinspecttime(Date dinspecttime) {
        this.dinspecttime = dinspecttime;
    }
    ...
    public Byte getBuploaded() {
        return buploaded;
    }

    public void setBuploaded(Byte buploaded) {
    ...
    public Byte getIsmddispatch() {
        return ismddispatch;
    }

    public void setIsmddispatch(Byte ismddispatch) {
        this.ismddispatch = ismddispatch;
    }
    ...
    public String toString() {
        ...
        sb.append(", isalebillid=").append(isalebillid);
        ...
        sb.append(", bscanexpress=").append(bscanexpress);
        sb.append(", cinspector=").append(cinspector);
        sb.append(", dinspecttime=").append(dinspecttime);
        sb.append(", cweighter=").append(cweighter);
        sb.append(", dweighttime=").append(dweighttime);
        sb.append(", buploaded=").append(buploaded);
        sb.append(", outid=").append(outid);
        sb.append(", ismddispatch=").append(ismddispatch);
