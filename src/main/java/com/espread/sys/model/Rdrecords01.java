...
public class Rdrecords01 implements Serializable {
    private Long autoid;
    ...
    public String toString() {
        ...
        sb.append(", iposid=").append(iposid);
        sb.append(", facost=").append(facost);
        ...
        sb.append(", chvencode=").append(chvencode);
        sb.append(", bgsp=").append(bgsp);
        sb.append(", cgspstate=").append(cgspstate);
        sb.append(", iarrsid=").append(iarrsid);
        ...
        sb.append(", ioritaxcost=").append(ioritaxcost);
        sb.append(", ioricost=").append(ioricost);
        sb.append(", iorimoney=").append(iorimoney);
        sb.append(", ioritaxprice=").append(ioritaxprice);
        sb.append(", iorisum=").append(iorisum);
        ...
        sb.append(", strcontractid=").append(strcontractid);
        sb.append(", strcode=").append(strcode);
        sb.append(", bchecked=").append(bchecked);
        sb.append(", brelated=").append(brelated);
        sb.append(", iomomid=").append(iomomid);
        sb.append(", imatsettlestate=").append(imatsettlestate);
        sb.append(", ibillsettlecount=").append(ibillsettlecount);
        ...
        sb.append(", isumbillquantity=").append(isumbillquantity);
        ...
        sb.append(", impcost=").append(impcost);
        sb.append(", iimosid=").append(iimosid);
        sb.append(", iimbsid=").append(iimbsid);
        sb.append(", cbarvcode=").append(cbarvcode);
        sb.append(", dbarvdate=").append(dbarvdate);
        ...
        sb.append(", ifaqty=").append(ifaqty);
        sb.append(", istax=").append(istax);
        ...
        sb.append(", idebitids=").append(idebitids);
        sb.append(", outcopiedquantity=").append(outcopiedquantity);
        sb.append(", ioldpartid=").append(ioldpartid);
        sb.append(", foldquantity=").append(foldquantity);
        sb.append(", cbsysbarcode=").append(cbsysbarcode);
        sb.append(", bmergecheck=").append(bmergecheck);
        sb.append(", imergecheckautoid=").append(imergecheckautoid);
        sb.append(", bnoitemused=").append(bnoitemused);
        sb.append(", creworkmocode=").append(creworkmocode);
        sb.append(", ireworkmodetailsid=").append(ireworkmodetailsid);
        sb.append(", iproducttype=").append(iproducttype);
        sb.append(", cmaininvcode=").append(cmaininvcode);
        sb.append(", imainmodetailsid=").append(imainmodetailsid);
        sb.append(", isharematerialfee=").append(isharematerialfee);
        ...
        sb.append(", gcupcardnum=").append(gcupcardnum);
        sb.append(", gcupid=").append(gcupid);
        sb.append(", gcupids=").append(gcupids);
