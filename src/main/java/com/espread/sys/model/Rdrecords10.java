...
public class Rdrecords10 implements Serializable {
    private Long autoid;
    ...
    public Long getIorderdetailid() {
        return iorderdetailid;
    }

    public void setIorderdetailid(Long iorderdetailid) {
    ...
    public String toString() {
        ...
        sb.append(", iorderdetailid=").append(iorderdetailid);
