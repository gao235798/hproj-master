...
public class Rdrecords32 implements Serializable {
    private Long autoid;
    ...
    private Byte irefundinspectflag;
    ...
    public Byte getIrefundinspectflag() {
        return irefundinspectflag;
    }

    public void setIrefundinspectflag(Byte irefundinspectflag) {
    ...
    public Integer getIeqdid() {
        return ieqdid;
    }

    public void setIeqdid(Integer ieqdid) {
        this.ieqdid = ieqdid;
    }
    ...
    public BigDecimal getFsettleqty() {
        return fsettleqty;
    }

    public void setFsettleqty(BigDecimal fsettleqty) {
        this.fsettleqty = fsettleqty;
    }

    public BigDecimal getFretqtywkp() {
        return fretqtywkp;
    }

    public void setFretqtywkp(BigDecimal fretqtywkp) {
        this.fretqtywkp = fretqtywkp;
    }

    public BigDecimal getFretqtyykp() {
        return fretqtyykp;
    }

    public void setFretqtyykp(BigDecimal fretqtyykp) {
    ...
    public String toString() {
        ...
        sb.append(", isbsid=").append(isbsid);
        sb.append(", isendquantity=").append(isendquantity);
        sb.append(", isendnum=").append(isendnum);
        sb.append(", iensid=").append(iensid);
        ...
        sb.append(", fsettleqty=").append(fsettleqty);
